...
export default function Signup(props) {
  ...
  const [alert, setAlert] = useState({ message1: "", message2: "" });
  ...
  function updatere(e) {
    ...
    if (e.target.value !== creds.password) {
      setAlert({ ...alert, message2: "password doesnt match" });
    } else {
      setAlert({ ...alert, message2: "" });
    }
  }
  ...
  async function sendsignup() {
    ...
    if (
      alert.message1.length === 0 &&
      alert.message2.length === 0 &&
        ...
        <div className="flex place-content-center">
          <div className="bg-grey-lighter pos-10 flex flex-col">
            <div className="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
              <div className="bg-gradient-to-r from-slate-200 via-gray-400 to-slate-200 px-6 py-8 rounded shadow-md text-black w-full">
                <button
                ...
                {(alert.message1.length || alert.message2.length) && (
                  <div
